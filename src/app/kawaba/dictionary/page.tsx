...
const dictionaryData = [
  ...
  { root: 'ban', isRoot: true, definitions: [{ pos: 'modifier', meaning: 'most' }] },
  { root: 'be', isRoot: true, definitions: [{ pos: 'noun', meaning: 'cause, reason' }, { pos: 'verb', meaning: 'to cause, to make happen, to bring about' }] },
  { root: 'ben', isRoot: true, definitions: [{ pos: 'verb', meaning: 'get, acquire, receive' }] },
  { root: 'bi', isRoot: true, definitions: [{ pos: 'noun', meaning: 'possessions, belongings, property'}, { pos: 'verb', meaning: 'to have, to own, to hold, to possess' }] },
  ...
  { root: 'bu', isRoot: true, definitions: [{ pos: 'noun', meaning: ' creation, fabrication, construction, production' }, { pos: 'verb', meaning: 'to make, to build, to create, to construct, to fabricate, to produce, to craft' }] },
  ...
  { root: 'ko', isRoot: true, definitions: [{ pos: 'modifier', meaning: 'small, little, tiny, minor' }, { pos: 'noun', meaning: 'smallness, littleness' }] },
  { root: 'kon', isRoot: true, definitions: [{ pos: 'modifier', meaning: 'soft, gentle' }] },
  { root: 'ku', isRoot: true, definitions: [{ pos: 'noun', meaning: 'what, which' }, { pos: 'modifier', meaning: 'what kind of, which' }] },
  ...
  { root: 'wu', isRoot: true, definitions: [{ pos: 'verb', meaning: 'to be alike, to be similar' }, { pos: 'noun', meaning: 'likeness, similarity' }, { pos: 'modifier', meaning: 'like, similar' }] },
];
